...
si0=0U;
si1=4736U;
i32_store(i->m0,(U64)si0+4760U,si1);
L1:;
si0=0U;
si1=l0;
si2=l0;
...
LOAD_DATA((*i->m0), 1024U, d0, 2416);
LOAD_DATA((*i->m0), 3440U, d1, 236);
}
